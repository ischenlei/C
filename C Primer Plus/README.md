...
##### 5.2.6 运算符优先级：![img](https://github.com/ischenlei/C/blob/master/images/1/Image2.png)  
...
3. 单独使用递增运算符时，使用哪种形式都没关系。但是，当运算符和运算对象是更复杂表达式的一部分时，使用前缀或后缀的效果不同。![img](https://github.com/ischenlei/C/blob/master/images/1/Image1.png)
...
3. 关系运算符的优先级比算术运算符（包括+和-）低，比赋值运算符高。![img](https://github.com/ischenlei/C/blob/master/images/1/Image3.png)
